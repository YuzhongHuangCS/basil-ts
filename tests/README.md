...
|-----:|----:|----:|:-------|:------|:-----------|:----------|:---------------|:-----------|:-----------|
|  2306|   10|    4|        | month | count      | no        |                | no         | 2018-07-31 |
...
How much crude oil will Saudi Arabia produce in July 2018?
...
|   IFP|    N|    h| lambda | time  | data\_type | data\_agg | partial\_train | partial\_y | end        |
|-----:|----:|----:|:-------|:------|:-----------|:----------|:---------------|:-----------|:-----------|
|  2099|  120|    1|        | day   | continuous | no        |                | no         | 2018-06-28 |
...
![](README_files/figure-markdown_github/arima-plots-closed-26.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-27.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-28.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-29.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-30.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-31.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-32.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-33.png)
...
![](README_files/figure-markdown_github/arima-plots-closed-34.png)
