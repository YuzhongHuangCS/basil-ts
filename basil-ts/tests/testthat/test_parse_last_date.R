...
test_that("It works with monthly data", {
  ...
  expect_equal(
    parse_data_updated_to(pr$`last-event-date`, pr$`aggregated-data`, pr$data_period, target),
    as.Date("2018-07-31"))
  expect_equal(
    parse_data_updated_to(NA, pr$`aggregated-data`, pr$data_period, target),
    as.Date("2018-07-31"))
  expect_equal(
    parse_data_updated_to(as.Date("2018-07-15"), pr$`aggregated-data`, pr$data_period, target),
    as.Date("2018-07-31"))
...
test_that("It works with daily data", {
  ...
  expect_equal(
    ...
    as.Date("2018-07-01"))
  expect_equal(
    parse_data_updated_to(as.Date("2018-07-01"), pr$`aggregated-data`, pr$data_period, target),
    as.Date("2018-07-01"))
...
test_that("last_event_date outside implied range throws an error", {
  ...
  expect_equal(
    ...
    as.Date("2018-07-01"))
  expect_error(
    parse_data_updated_to(as.Date("2018-06-15"), pr$`aggregated-data`, pr$data_period, target),
